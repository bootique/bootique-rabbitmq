...
public abstract class RmqTester_GlobalScopeIT {
    ...
    protected void assertCanOpenChannel(RmqConnectionManager connectionManager) throws IOException, TimeoutException {
